...
export default function StudentsPage() {
  ...
  useEffect(() => setTitle("Students"), [setTitle]);
  ...
  const columns: GridColDef[] = [
    ...
    { field: "yearOfStudy", headerName: "Year", flex: 0.8 },
    {
      field: "actions",
      type: "actions",
      headerName: "Actions",
  ...
  return (
    <>
      ...
      >
        <DialogTitle sx={{ color: themeColor, fontWeight: 700, fontSize: "1.2rem" }}>
        ...
        <DialogContent sx={{ display: "flex", flexDirection: "column", gap: 2, mt: 2 }}>
          ...
          <TextField label="Registration Number" value={formData.registrationNumber} onChange={(e) => setFormData({ ...formData, registrationNumber: e.target.value })} />
          <TextField label="Course" value={formData.course} onChange={(e) => setFormData({ ...formData, course: e.target.value })} />
          <TextField label="Year of Study" value={formData.yearOfStudy} onChange={(e) => setFormData({ ...formData, yearOfStudy: e.target.value })} />
        </DialogContent>
